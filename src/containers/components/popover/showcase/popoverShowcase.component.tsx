...
import { Button, CheckBoxProps, Popover, PopoverProps } from '@kitten/ui';
import { PopoverContent, PopoverContentProps } from './popoverContent.component';
...
export class PopoverShowcase extends React.Component<any, PopoverShowcaseComponentState> {
  ...
  public render(): React.ReactElement<CheckBoxProps> {
    ...
    return (
      <Popover {...this.props} visible={this.state.visible} content={this.renderContentElement()} onRequestClose={this.onRequestClose}>
