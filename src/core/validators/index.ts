...
export const CpfNumberValidator = (value: string): boolean => {
  return RegExpValidator(PATTERN_CPF_NUMBER, value);
};

export const CepNumberValidator = (value: string): boolean => {
